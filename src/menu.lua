...
function scene:create( event )
    ...
    local title = display.newImageRect( sceneGroup, "resources/image/logo_1.png", 160, 160 )
    ...
    local btn_option = display.newImageRect( sceneGroup, "resources/image/btn_options.png", 148, 45 )
